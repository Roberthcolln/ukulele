...
<head>
  ...
  <title>Admin | {{ $konf->perusahaan_setting }}</title>
  ...
  <link rel="shortcut icon" href="{{ asset('logo/'.$konf->logo_setting) }}">
  {{-- leaflet --}}
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="{{ route('dashboard.index') }}" class="brand-link text-center">
        <!-- <span class="brand-text font-weight-light"><img src="{{ asset('logo/'.$konf->logo_setting) }}" style="width: 120px; align: center" alt=""></span> -->
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            ...
            @else
            <img src="{{ asset('logo/'.$konf->logo_setting) }}" class="img-circle elevation-2" alt="Logo Oenic" style="width: 45px; height: 45px">
            @endif
          </div>
          <div class="info">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="{{ route('presensi_pic.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>PIC</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('presensi_peserta.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Peserta</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="{{ route('presensi_ukulele.index') }}" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Ukulele</p>
                  </a>
                </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('kategori_kelompok.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kateg.. Kelom Ukulele</p>
                </a>
              </li>

              <li class="nav-item">
                <a href="{{route('artis.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Artis</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('sponsorship.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Sponsorship</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{route('wilayah_participant.index')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Wilayah Participant</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              @if( Auth::user()->id == 1 )
              <li class="nav-item">
                <a href="{{ route('pic_kelompok_ukulele.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Pic Kelompok</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="{{ route('ukulele.index') }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Ukulele</p>
                </a>
              </li>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; <?php $cpy = date('Y');
                                echo $cpy; ?><a href="{{ route('dashboard.index') }}"> PT. Solusi Pasti Untuk Indonesia</a>.</strong> All rights reserved.
    </footer>
  ...
  <script type="text/javascript">
    $('.show_confirm').click(function(event) {
      ...
      swal({
          ...
          text: "Data ini akan hilang dari database anda",
          icon: "warning",
          buttons: true,
          dangerMode: true,
        })
