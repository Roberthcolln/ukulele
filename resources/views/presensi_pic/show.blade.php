    ...
    <div class="col">
        <div class="card">
            <div class="card-header">
                ...
                <a href="{{ route('presensi_pic.index') }}" class="btn btn-warning" style="float: right;"><i class="fas fa-arrow-left"></i> Kembali</a>
            </div>
            <div class="card-body table table-responsive">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th style="width: 20px;">:</th>
                        <td>{{ $result->nama_kelompok_ukulele }}</td>
                    </tr>
                    <tr>
                        <th style="width: 30%;">Foto</th>
                        <th style="width: 20px;">:</th>
                        <td><img src="{{ asset('file/pic_kelompok_ukulele/'.$result->foto) }}" alt="" style="width: 100px;"></td>
                    </tr>
                </table>
            </div>
        </div>
