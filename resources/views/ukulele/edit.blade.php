                ...
                <form action="{{ route('peserta.update', $data->id_peserta_ukulele) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="kecamatan" id="dropdown4">
                            ...
                            <option value=""></option>
                            <option @if( $data->kecamatan_peserta == $row->nama_kecamatan ) selected @endif value="{{ $row->nama_kecamatan }}">{{ $row->nama_kecamatan }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="kabupaten" id="dropdown5">
                            ...
                            <option value=""></option>
                            <option @if( $data->kabupaten_peserta == $row->nama_kabupaten ) selected @endif value="{{ $row->nama_kabupaten }}">{{ $row->nama_kabupaten }}</option>
                            @endforeach
                        </select>
